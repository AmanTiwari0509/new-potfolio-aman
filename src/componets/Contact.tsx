...
const Contact = () => {
    return (
        <div className='md:h-screen h-auto screen3 pt-10'>
            <div className='flex flex-col gap-4 justify-center items-center'>
                <div className='text-4xl font-bold border-t-4 border-t-white border-b-blue-400 border-b-4 border-solid p-2 text-center text-white '>Contact</div>
            </div>
            <div className='pt-10'>
                <div className='md:grid md:grid-cols-2'>
                    <div className=' flex flex-col gap-4 md:pt-20 pt-10 md:px-36 px-4   '>
                        <div className='border-b-2 border-blue-400 w-20 text-2xl text-white '>Details</div>
                        <div className=' text-white text-left flex justify-end items-center  '> Innovative web app, modern design, seamless navigation, and robust functionality. Elevated user experience with responsive layouts and intuitive features.</div>
                    ...
                    <div className='flex flex-col gap-8 py-10 '>
                        ...
                        <div className='flex md:justify-start justify-center items-center md:pl-8 pl-0'>
                            <button className='border border-white text-white text-center p-4 hover:bg-blue-400'>Send Message</button>
                        </div>
                    </div>
                </div>
            </div>
