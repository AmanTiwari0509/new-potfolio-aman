...
const Services = () => {
    return (
        <div className='w-full md:h-screen h-auto bg-white md:pt-32 pt-16'>
            ...
            <div className='md:grid md:grid-cols-4 flex flex-col gap-4 items-center justify-center md:py-36 py-16  md:pl-20 pl-0'>
