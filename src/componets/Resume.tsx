...
const experence = [
  ...
  },
  {
    ...
    description:
      "I was responsible to integrate innovative motion design elements into applications, collaborating with design team to implement motion design elements, Creating reacts components, Fixing the UI related issues, attend the agile meetings and collaborate with team members of all projects for our clients.",
  },
  {
    companyName: "Ksolves",
    ...
    description:
      "I was responsible for developing and maintaining user interface, focusing on enhancing user experiences through motion design, implementing responsive and mobile friendly design and collaborating with design and backend team of all projects for clients",
  },
  {
    ...
    role: "Sr. Front End Developer",
    description:
      "I was responsible for converting Figma design to functional UI, building reusable components for the application integrating the Api’s for enhanced functionality of all projects for our company",
  },
];
    ...
    <>
      <div className="py-10 h-full lg:block hidden">
        <div className="flex flex-col gap-4 justify-center items-center">
          <div className="text-4xl font-bold border-t-4 border-t-black border-b-blue-400 border-b-4 border-solid p-2 text-center ">
            Resume
          </div>
        </div>
        <div className="flex justify-center items-center pt-20">
          ...
          <div className="rounded-full border-2 w-[150px] h-[150px]  bg-blue-400 flex p-4 relative ">
            <img
              src={work}
              alt=""
              className=" absolute top-0 left-0 right-0 bottom-0 m-auto w-20 h-20 flex items-center justify-center"
            />
          </div>
        ...
        {experence?.map((item: any) => (
          <div className="flex  gap-2 pt-20">
            ...
            <div className={`w-[70%]`}>
              <h1 className="text-xl font-bold">{item.companyName}</h1>
              <p className="text-lg text-blue-400">{item.role}</p>
              <p className={` "text-left pr-20" tracking-wide text-gray-400 `}>
                {item.description}
              </p>
            </div>
          </div>
